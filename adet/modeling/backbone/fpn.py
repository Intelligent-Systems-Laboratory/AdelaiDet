...
@BACKBONE_REGISTRY.register()
def build_fcos_effnet_fpn_backbone(cfg, input_shape: ShapeSpec):
    """builds efficienet with FPN
    Args:
        cfg: a detectron2 CfgNode
...
@BACKBONE_REGISTRY.register()
def build_retinanet_effnet_fpn_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
        cfg: a detectron2 CfgNode
    Returns:
