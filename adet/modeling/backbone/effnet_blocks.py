...
def norm2d(cfg, w_in):
    ...
    return nn.BatchNorm2d(num_features=w_in, eps=cfg.MODEL.BN.EPS, momentum=cfg.MODEL.BN.MOM)
...
def activation(cfg):
    ...
    activation_fun = cfg.MODEL.EN.ACTIVATION_FUN.lower()
    if activation_fun == "relu":
        return nn.ReLU(inplace=cfg.MODEL.EN.ACTIVATION_INPLACE)
...
def init_weights(m):
    ...
    if isinstance(m, nn.Conv2d):
        ...
        #zero_init_gamma = m.cfg.MODEL.BN.ZERO_INIT_FINAL_GAMMA
