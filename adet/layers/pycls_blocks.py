...
def init_weights(m):
    ...
    if isinstance(m, nn.Conv2d):
        ...
        #TODO: Zero initialize the Final Batchnorm similar to Detectron2 Resnet discussion
        # Reference: https://github.com/facebookresearch/detectron2/blob/d3a429532dc26f74590977b55b13d62b566abb85/detectron2/modeling/backbone/resnet.py#L183
